...
4. Добавьте конфигурацию запуска.
    1. В поле **Name** зададим *JarWalkTestGitBash*, где префикс *Jar* означает, что мы компилируем и запускаем тесты через .jar-файлы; *WalkTest* - версию домашнего задания (easy/hard/bonus); суффикс *GitBash* - тестирование проходит через приложение GitBash.
...
6. Добавьте конфигурацию запуска.
    1. В поле **Name** зададим *JarWalkTestWSL*, где префикс *Jar* означает, что мы компилируем и запускаем тесты через .jar-файлы; *WalkTest* - версию домашнего задания (easy/hard/bonus); суффикс *WSL* - тестирование проходит через WSL.
